...
const file_rustplus_proto_rawDesc = "" +
	...
	"maxPlayers\x12$\n" +
	"\rqueuedPlayers\x18\t \x02(\rR\rqueuedPlayers\x12\x12\n" +
	"\x04seed\x18\n" +
	...
	"\ramountInStock\x18\x05 \x02(\x05R\ramountInStock\x12(\n" +
	"\x0fitemIsBlueprint\x18\x06 \x02(\bR\x0fitemIsBlueprint\x120\n" +
	"\x13currencyIsBlueprint\x18\a \x02(\bR\x13currencyIsBlueprint\x12$\n" +
